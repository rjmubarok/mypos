            ...
            <div class="card profile-header">
                <div class="body text-center">
                    <div class="profile-image mb-3">
                        <img src="{{ auth()->user()->photo ?? '/assets/images/user.png' }}" class="rounded-circle w-50" alt="">
                    </div>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="url" id="website" class="form-control" placeholder="http://">
                </div>
                <div class="col-12 col-md-6 mb-3">
                    <label for="address1" class="form-label">Address Line 1</label>
                    <input type="text" id="address1" class="form-control" placeholder="Enter Address Line 1">
                </div>
                <div class="col-12 col-md-6 mb-3">
                    <label for="address2" class="form-label">Address Line 2</label>
                    <input type="text" id="address2" class="form-control" placeholder="Enter Address Line 2">
                </div>
                <div class="col-12 col-md-6 mb-3">
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <input type="text" id="state" class="form-control" placeholder="Enter State/Province">
                </div>
            </div>
            <div class="mt-3">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="email" id="email" class="form-control" value="alizee.info@yourdomain.com">
                </div>
                <div class="col-12 mb-3">
